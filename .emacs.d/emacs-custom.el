(custom-set-variables
 ...
 '(package-selected-packages
   '(lambda-line dap-mode git-gutter vimrc-mode yaml-mode xclip vertico use-package undo-fu-session undo-fu org-bullets orderless mood-line minions magit lua-mode lsp-ui lsp-pyright lsp-java json-mode ivy-prescient hl-todo gruber-darker-theme git-gutter-fringe gcmh format-all flycheck evil-nerd-commenter dashboard counsel company-prescient company-box all-the-icons)))
(custom-set-faces
