...
vim.api.nvim_set_hl(0, "LineNr", { bg = "#0C0C0C", fg = "#A5A5A5" })
vim.api.nvim_set_hl(0, "CursorLineNR", { fg = "#454545" })
vim.api.nvim_set_hl(0, "CursorLineNR", { fg = "#454545" })
vim.api.nvim_set_hl(0, "NonText", { bg = "#0C0C0C", fg = Gray_color })
vim.api.nvim_set_hl(0, "SignColumn", { bg = "#0C0C0C" })
vim.api.nvim_set_hl(0, "StatusLine", { fg = Main_color, bg = "#121212" })
...
vim.api.nvim_set_hl(0, "NormalFloat", { fg = "#c6c6c6", bg = "#0C0C0C" })
vim.api.nvim_set_hl(0, "Pmenu", { fg = Main_color, bg = "#0C0C0C" })
vim.api.nvim_set_hl(0, "PmenuSel", { bg = "#0b1e33" })
vim.api.nvim_set_hl(0, "PmenuThumb", { bg = Gray_color })
vim.api.nvim_set_hl(0, "ModeMsg", { fg = Main_color, bg = "#0C0C0C" })
vim.api.nvim_set_hl(0, "TabLineSel", { fg = Main_color, bg = "#0C0C0C" })
vim.api.nvim_set_hl(0, "WarningMsg", { fg = Yellow_color, bg = "#0C0C0C" })
vim.api.nvim_set_hl(0, "FloatBorder", { fg = Function_color, bg = "#0C0C0C" })
vim.api.nvim_set_hl(0, "MatchParen", { bg = "#0C0C0C", fg = Red_color, underline = true })
...
--URI
vim.api.nvim_set_hl(0, "@text.uri", { fg = Main_color, bg = "#0C0C0C", underline = true })
