...
local function get_diagnostics(opts)
    ...
    return function()
        ...
        local counts =
            { DiagnosticSignError = 0, DiagnosticSignWarn = 0, DiagnosticSignHint = 0, DiagnosticSignInfo = 0 }
...
local function get_python_venv(opts)
    ...
    return function()
        ...
        local python = require('core.helpers.python')
...
vim.o.rulerformat = '%50(%=%#Comment# Ln: %l, Col: %c%V%)'
